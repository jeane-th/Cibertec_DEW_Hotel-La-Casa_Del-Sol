...
const informativoNosotros01 = `Bienvenidos a La Casa del Sol, un espacio pensado para ofrecer comodidad, tranquilidad y 
...
const informativoNosotros02 = `Como parte de nuestro compromiso con la mejora continua, hemos desarrollado una plataforma 
    ...
    <section id="sobre-nosotros" className="seccion">
      <div className="container">
        ...
        <div className="cuadricula-sobre-nosotros">
          <div>
            <p>{informativoNosotros01}</p>
            <br />
            <p>{informativoNosotros02}</p>
          </div>
